...
Apprenez à créer un projet de plugin Hytale correctement structuré en utilisant Gradle et Java 21.
...
repositories {
    mavenCentral()
    // Dépôt API Hytale (quand disponible)
    maven {
        name = 'hytale'
...
dependencies {
    // API Serveur Hytale - compileOnly car le serveur la fournit
