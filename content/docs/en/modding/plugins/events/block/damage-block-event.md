...
|-------|------|----------|-------------|
| `itemInHand` | `ItemStack` | `getItemInHand()` | The item/tool being used to damage the block |
...
|--------|-----------|-------------|
| `getItemInHand` | `public ItemStack getItemInHand()` | Returns the tool/item used to damage the block |
