...
sidebar_label: Entity Spawning
sidebar_position: 15
description: Complete documentation of the Hytale entity spawning system for natural mob spawning, spawn markers, spawn beacons, and block spawners
---
...
|------------|-------------|
| `Light` | Total combined light level (0-100) |
| `SkyLight` | Light based on depth underground (0-100) |
| `Sunlight` | Light based on time of day (0-100) |
| `RedLight` | Red light level (0-100) |
| `GreenLight` | Green light level (0-100) |
| `BlueLight` | Blue light level (0-100) |
